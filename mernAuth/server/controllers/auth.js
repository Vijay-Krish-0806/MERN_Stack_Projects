...
exports.googleLogin = async (req, res) => {
  const client = new OAuth2Client("13651812709-lo9jq1ue2udhm070lsvvpdja9qqnf8q3.apps.googleusercontent.com");
  try {
    const { code } = req.body;
    console.log(code,"\n");
    ...
    const response = await client.verifyIdToken({
      idToken: code,
      audience: "13651812709-lo9jq1ue2udhm070lsvvpdja9qqnf8q3.apps.googleusercontent.com",
    });
